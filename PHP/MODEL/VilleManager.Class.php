...
class VilleManager 
{
	...
	{
 		$db=DbConnect::getDb();
		$q=$db->prepare("UPDATE Ville SET idVille=:idVille,nomVille=:nomVille, numeroDepartement=:numeroDepartement, codePostal=:codePostal, dateMAJ=:dateMAJ WHERE idVille=:idVille");
